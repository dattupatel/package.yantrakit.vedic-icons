...
const AVAILABLE_ICONS = ['aarti','aarti-02','agni-dev','ashoka-chakra','brahma','calendar-holi','calendar-om','calendar-pongol','calendar-swastika','chandra','chandra-02','coin','diya','diya-02','diya-03','durga','face-male-sikh','family-gathering','female','firecracker','firecracker-02','ganesha','golden-temple','granth-om','granth-swastika','hand-holding-rupee','hanumaan','hanumaan-02','havan-fire','incense','india-map','indian-flag','indra','kalash-swastika','kali','kartikeya','konark-sun-temple','krishna','krishna-02','krishna-with-cow','kurma','lakshmi','lal-qila','lingam','lotus','mala','male-sikh','male-sikh02','mandala','mandala-02','matsya','meenakshi-temple','namaste','narasimha','om','parvati','peacock','qutub-minar','radha','rama','rangoli','rudraksha','saraswati','scroll','scroll-02','scroll-03','scroll-rolled','scroll-rolled02','shankh','shiva','sindoor','sita','surya','taj-mahal','temple','tilak','trishul','vamana','varaha','yama','yantra'];
